...
export default function SearchUneversal({onSearch}) {
  return (
    <div className='flex mt-10 ml-10 '>
      <input type="search" id='inp_search' onChange={(e) => onSearch(e.target.value)} className='bg-slate-50 lg:!w-1200 lg:!h-14 !h-10 !w-80 p-4 focus:border-e-red-600' placeholder='Search..' />
